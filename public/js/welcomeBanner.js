...
(function () {
  ...
  if (sessionStorage.getItem("athithiWelcomeBannerDismissed")) {
  ...
  closeBtn.addEventListener("click", function () {
    banner.style.display = "none";
    sessionStorage.setItem("athithiWelcomeBannerDismissed", "1");
  });

  // Listen for a custom event to clear the flag on logout
  window.addEventListener("athithi-logout", function () {
    sessionStorage.removeItem("athithiWelcomeBannerDismissed");
  });
})();
